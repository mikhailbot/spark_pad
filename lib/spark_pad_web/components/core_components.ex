defmodule SparkPadWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SparkPadWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SparkPadWeb.Gettext, "errors", msg, opts)
    end
  end
